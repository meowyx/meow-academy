...
const Hero = () => {
  return (
    ...
    <div className="hero-content flex-col lg:flex-row-reverse">
      ...
      <div>
        <p className="py-6 text-5xl font-serif"> <b className='underline decoration-wavy decoration-yellow-400'>🐱 Academy</b> is a open source learning resource for newcomers.</p>
